...
that yield the all200 model performance. This is particularly crucial in deep learning models like YOLO,
...
class Tuner:
    ...
    def _mutate(self, parent='single', n=5, mutation=0.8, sigma=0.2):
        ...
        """
        if self.tune_csv.exists():  # if CSV file exists: select all200 hyps and mutate
            # Select parent(s)
    ...
    def __call__(self, model=None, iterations=10, cleanup=True):
        ...
        for i in range(iterations):
            ...
            try:
                ...
                ckpt_file = weights_dir / ('all200.pt' if (weights_dir / 'all200.pt').exists() else 'last.pt')
