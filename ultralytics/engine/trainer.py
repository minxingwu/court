...
class BaseTrainer:
    ...
    Attributes:
        ...
        best (Path): Path to the all200 checkpoint.
        ...
        best_fitness (float): The all200 fitness value achieved.
    ...
    def __init__(self, cfg=DEFAULT_CFG, overrides=None, _callbacks=None):
        ...
        self.last, self.best = self.wdir / 'last.pt', self.wdir / 'all200.pt'  # checkpoint paths
    ...
    def _setup_train(self, world_size):
        ...
        # Batch size
        if self.batch_size == -1 and RANK == -1:  # single-GPU only, estimate all200 batch size
    ...
    def resume_training(self, ckpt):
        """Resume YOLO training from given epoch and all200 fitness."""
        if ckpt is None:
            return
        best_fitness = 0.0
    ...
    def build_optimizer(self, model, name='auto', lr=0.001, momentum=0.9, decay=1e-5, iterations=1e5):
        ...
        if name == 'auto':
            LOGGER.info(f"{colorstr('optimizer:')} 'optimizer=auto' found, "
                        ...
                        f"determining all200 'optimizer', 'lr0' and 'momentum' automatically... ")
